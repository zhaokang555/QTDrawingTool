...
static const char qt_meta_stringdata_a[] = {
    "a\0"
};
...
const QMetaObjectExtraData a::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject a::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_a,
      qt_meta_data_a, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &a::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_a))
